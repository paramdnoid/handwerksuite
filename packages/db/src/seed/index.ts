...
async function seed() {
  ...
  const coreModules = await db
    ...
    .values([
      ...
      {
        key: 'rechnungsstellung',
        name: 'Rechnungsstellung',
        description: 'Rechnungen, Angebote und Kostenvoranschläge',
        category: 'core',
        icon: 'Receipt',
        isCore: true,
        sortOrder: 3,
      },
      {
        key: 'zeiterfassung',
        name: 'Zeiterfassung',
        description: 'Arbeitszeiten und Projektzeiten erfassen',
        category: 'core',
        icon: 'Clock',
        isCore: true,
        sortOrder: 4,
      ...
      {
        key: 'dokumentenverwaltung',
        name: 'Dokumentenverwaltung',
        description: 'Dokumente und Dateien organisieren',
        category: 'core',
        icon: 'FileText',
        isCore: true,
        sortOrder: 5,
      },
      {
        key: 'terminplanung',
        name: 'Terminplanung',
        description: 'Termine und Einsatzplanung',
        category: 'core',
        icon: 'Calendar',
        isCore: true,
        sortOrder: 6,
      },
      {
        ...
        description: 'Team und Mitarbeiter verwalten',
        category: 'core',
        icon: 'UserCog',
        isCore: true,
        sortOrder: 7,
  ...
  const craftModules = await db
    ...
    .values([
      // Schornsteinfeger
      {
        key: 'kehrbuch',
        name: 'Kehrbuch',
        description: 'Digitales Kehrbuch nach KÜO',
      ...
      {
        key: 'feuerschau',
        name: 'Feuerstättenschau',
        description: 'Feuerstättenschau-Protokolle',
        category: 'pruefung',
        icon: 'Shield',
        isCore: false,
        sortOrder: 11,
      },
      {
        key: 'abgasmessung',
        name: 'Abgasmessung',
        description: 'Abgasmessung und Emissionsprüfung',
        category: 'pruefung',
        icon: 'Gauge',
        isCore: false,
        sortOrder: 12,
      },
      {
        key: 'co_warnercheck',
        name: 'CO-Warnercheck',
        description: 'CO-Warner-Überprüfung',
        category: 'pruefung',
        icon: 'AlertTriangle',
        isCore: false,
        sortOrder: 13,
      ...
      // Elektro
      {
        key: 'e_check',
        name: 'E-Check',
        description: 'E-Check Prüfprotokolle',
        category: 'pruefung',
        icon: 'Zap',
        isCore: false,
        sortOrder: 20,
      ...
      {
        key: 'dguv_v3',
        name: 'DGUV V3 Prüfung',
        description: 'DGUV Vorschrift 3 Prüfprotokolle',
        category: 'pruefung',
        icon: 'ClipboardCheck',
        isCore: false,
        sortOrder: 21,
      ...
      {
        key: 'schaltplanerstellung',
        name: 'Schaltplanerstellung',
        description: 'Schaltpläne erstellen und verwalten',
        category: 'branchenspezifisch',
        icon: 'CircuitBoard',
        isCore: false,
        sortOrder: 22,
      ...
      // SHK
      {
        ...
        description: 'Wartungsprotokolle für Heizungsanlagen',
        category: 'pruefung',
        icon: 'Thermometer',
        isCore: false,
        sortOrder: 30,
      ...
      {
        key: 'rohrnetzberechnung',
        name: 'Rohrnetzberechnung',
        description: 'Berechnung von Rohrnetzen',
        category: 'branchenspezifisch',
        icon: 'GitBranch',
        isCore: false,
        sortOrder: 31,
      },
      {
        key: 'energieausweis',
        name: 'Energieausweis',
        description: 'Energieausweis-Erstellung nach GEG',
        category: 'branchenspezifisch',
        icon: 'Leaf',
        isCore: false,
        sortOrder: 32,
      ...
      // Maler
      {
        key: 'farbmischung',
        name: 'Farbmischung',
        description: 'Farbrezepturen und Mischverhältnisse',
        category: 'branchenspezifisch',
        icon: 'Palette',
        isCore: false,
        sortOrder: 40,
      ...
      {
        key: 'aufmassung',
        name: 'Aufmaßerfassung',
        description: 'Digitale Aufmaßerfassung vor Ort',
        category: 'verwaltung',
        icon: 'Ruler',
        isCore: false,
        sortOrder: 41,
      },
      {
        key: 'raumberechnung',
        name: 'Raumberechnung',
        description: 'Flächen- und Raumberechnung',
        category: 'verwaltung',
        icon: 'Square',
        isCore: false,
        sortOrder: 42,
      ...
      // Dachdecker
      {
        key: 'dachaufmass',
        name: 'Dachaufmaß',
        description: 'Digitales Dachaufmaß mit Neigungsberechnung',
        category: 'branchenspezifisch',
        icon: 'Home',
        isCore: false,
        sortOrder: 50,
      ...
      {
        key: 'holzliste',
        name: 'Holzliste / Abbundplan',
        description: 'Holzlisten und Abbundpläne erstellen',
        category: 'branchenspezifisch',
        icon: 'TreePine',
        isCore: false,
        sortOrder: 60,
      ...
      // KFZ
      {
        key: 'fahrzeugakte',
        name: 'Fahrzeugakte',
        description: 'Digitale Fahrzeugakten und Wartungshistorie',
        category: 'branchenspezifisch',
        icon: 'Car',
        isCore: false,
        sortOrder: 70,
      ...
      {
        key: 'hu_vorbereitung',
        name: 'HU-Vorbereitung',
        description: 'Hauptuntersuchung vorbereiten',
        category: 'pruefung',
        icon: 'BadgeCheck',
        isCore: false,
        sortOrder: 71,
  ...
  await db.insert(craftTypeModules).values([
    ...
    {
      craftType: 'schornsteinfeger',
      moduleId: moduleByKey('kehrbuch'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
    {
      craftType: 'schornsteinfeger',
      moduleId: moduleByKey('feuerschau'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
    {
      craftType: 'schornsteinfeger',
      moduleId: moduleByKey('abgasmessung'),
    ...
    {
      craftType: 'schornsteinfeger',
      moduleId: moduleByKey('co_warnercheck'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
    ...
    {
      craftType: 'elektro',
      moduleId: moduleByKey('e_check'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
    {
      craftType: 'elektro',
      moduleId: moduleByKey('dguv_v3'),
    ...
    {
      craftType: 'elektro',
      moduleId: moduleByKey('schaltplanerstellung'),
      platform: 'web' as const,
    ...
    {
      craftType: 'shk',
      moduleId: moduleByKey('heizungswartung'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
    {
      craftType: 'shk',
      moduleId: moduleByKey('rohrnetzberechnung'),
      platform: 'web' as const,
      enabledByDefault: true,
    },
    {
    ...
    {
      craftType: 'shk',
      moduleId: moduleByKey('energieausweis'),
      platform: 'web' as const,
      enabledByDefault: false,
    },
    ...
    {
      craftType: 'maler',
      moduleId: moduleByKey('farbmischung'),
      platform: 'mobile' as const,
      enabledByDefault: true,
    },
    {
      craftType: 'maler',
      moduleId: moduleByKey('aufmassung'),
      platform: 'mobile' as const,
      enabledByDefault: true,
    },
    {
    ...
    {
      craftType: 'maler',
      moduleId: moduleByKey('raumberechnung'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
    ...
    // Dachdecker modules
    {
      craftType: 'dachdecker',
      moduleId: moduleByKey('dachaufmass'),
      platform: 'mobile' as const,
      enabledByDefault: true,
    },
    {
    ...
    {
      craftType: 'zimmerer',
      moduleId: moduleByKey('holzliste'),
      platform: 'desktop' as const,
      enabledByDefault: true,
    },
    {
    ...
    {
      craftType: 'kfz',
      moduleId: moduleByKey('fahrzeugakte'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
    {
      craftType: 'kfz',
      moduleId: moduleByKey('hu_vorbereitung'),
      platform: 'all' as const,
      enabledByDefault: true,
    },
  ]);
