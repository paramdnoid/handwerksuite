...
CREATE TYPE "public"."tenant_type" AS ENUM('craft_business', 'authority');--> statement-breakpoint
CREATE TYPE "public"."tenant_role" AS ENUM('owner', 'admin', 'manager', 'employee', 'readonly');--> statement-breakpoint
...
CREATE TABLE "tenant_members" (
	...
	"user_id" uuid NOT NULL,
	"role" "tenant_role" DEFAULT 'employee' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "authority_assignments" ADD CONSTRAINT "authority_assignments_authority_tenant_id_tenants_id_fk" FOREIGN KEY ("authority_tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "authority_assignments" ADD CONSTRAINT "authority_assignments_craft_tenant_id_tenants_id_fk" FOREIGN KEY ("craft_tenant_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
